...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 2rem; margin: 2rem 0;">
  ...
  <div>
    ...
    <h3>Two_Boys_Textured_Smooth_Shading_Front_View.png</h3>
    <p>Short description.</p>
  </div>
  ...
  <div>
    ...
    <h3>Two_Boys_Textured_Smooth_Shading_T-Pose_Front_View.png</h3>
    <p>Short description.</p>
  </div>
